...
| [portfolio](https://github.com/GROWX-Inc/portfolio) | **ポートフォリオ作品集**。社内制作のモーション・デザイン作品を番号フォルダで格納 | `{番号}/index.html`（`01`, `02`…）＋作品台帳（README.md） |
